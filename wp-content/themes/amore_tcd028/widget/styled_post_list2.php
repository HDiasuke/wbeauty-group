...
?>
 <li class="clearfix">
   <a class="image" href="<?php the_permalink() ?>"><div class="thumb" style="width:100%; height:auto;"><?php if ( has_post_thumbnail()) { echo the_post_thumbnail('widget_size3'); } else { echo '<img src="'; bloginfo('template_url'); echo '/img/common/no_image2.gif" alt="" title="" />'; }; ?></div></a>
   <?php if( $show_date == '1' ) { ?>
   <p class="date"><span class='fa fa-clock-o mr5'></span><?php the_time('Y.m.d'); ?></p>
   <?php }; ?>
