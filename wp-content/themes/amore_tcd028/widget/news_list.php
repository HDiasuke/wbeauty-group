...
<a class="news_widget_list_link" href="<?php echo get_post_type_archive_link('news'); ?>"><?php _e("Archives","tcd-w"); ?></a>
<?php } else { ?>
...
// End class widget
add_action('widgets_init', create_function('', 'return register_widget("tcdw_news_list_widget");'));
?>