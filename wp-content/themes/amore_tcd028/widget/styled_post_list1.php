...
?>
 <li class="clearfix">
   ...
   <a class="image" href="<?php the_permalink() ?>"><div class="thumb" style="width:100%; height:auto;"><?php if ( has_post_thumbnail()) { the_post_thumbnail('size3'); } else { echo '<img src="'; bloginfo('template_url'); echo '/img/common/no_image1.gif" alt="" title="" />'; }; ?></div></a>
   </div>
    <?php if( $show_date == '1' || $show_cate == '1' ) { ?>
    <p class="dateandcate">
  <?php if( $show_date == '1' ) { ?><span class='fa fa-clock-o'></span><span class="date"><?php the_time('Y.m.d'); ?></span><?php }; ?>
