...
function mytheme_add_box() {
  ...
  add_meta_box($meta_box['id'], $meta_box['title'], 'mytheme_show_box', 'ranking_post', $meta_box['context'], $meta_box['priority']);
  add_meta_box($meta_box['id'], $meta_box['title'], 'mytheme_show_box', 'ranking_post2', $meta_box['context'], $meta_box['priority']);
  add_meta_box($meta_box['id'], $meta_box['title'], 'mytheme_show_box', 'ranking_post3', $meta_box['context'], $meta_box['priority']);
}
