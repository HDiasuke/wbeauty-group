...
<!--Type1-->
<?php if ( $options['sns_type_top']=='type1' ) : ?>
...
<?php if ( $options['show_twitter_top'] ) : ?><!--Twitterボタン-->
<li class="twitter"> 
...
<?php if ( $options['show_fbshare_top'] ) : ?><!--Facebook-シェアボタン-->
<li class="facebook">
...
<?php if ( $options['show_google_top'] ) : ?><!--Google+ボタン-->
<li class="googleplus">
...
<?php if ( $options['show_hatena_top'] ) : ?><!--Hatebuボタン-->
<li class="hatebu">
...
<?php if ( $options['show_pocket_top'] ) : ?><!--Pocketボタン-->
<li class="pocket">
...
<?php if ( $options['show_pinterest_top'] ) : ?><!--Pinterestボタン-->
<li class="pinterest">
...
<?php if ( $options['show_fbshare_top'] ) : ?><!--Facebookボタン-->
<li class="facebook">
<a href="//www.facebook.com/sharer/sharer.php?u=<?php the_permalink() ?>&amp;t=<?php echo $title_encode ?>" class="facebook-btn-icon-link" target="blank" rel="nofollow"><i class="icon-facebook"></i><span class="ttl">Share</span><span class="share-count"><?php if(function_exists('scc_get_share_facebook')) echo (scc_get_share_facebook()==0)?'':scc_get_share_facebook(); ?></span></a></li>
<?php endif; ?>
...
<!--Type2-->
<?php if ( $options['sns_type_top']=='type2' ) : ?>
...
<!--Type3-->
<?php if ( $options['sns_type_top']=='type3' ) : ?>
...
<!--Type4-->
<?php if ( $options['sns_type_top']=='type4' ) : ?>
...
<!--Type5-->
<?php if ( $options['sns_type_top']=='type5' ) : ?>
<div id="share5_top">
...
<?php if ( $options['show_fblike_top'] ) : ?><!-- Facebookいいねボタン -->
...
<?php if ( $options['show_fbshare_top'] ) : ?><!-- Facebookシェアボタン -->
