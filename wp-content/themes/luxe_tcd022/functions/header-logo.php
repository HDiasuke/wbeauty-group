...
function the_dp_logo(){
  ...
  if($logo){
    ...
    echo '<h1 id="logo" style="top:' . $option['logotop'] . 'px; left:' . $option['logoleft'] . 'px;"><a href=" ' . $url . '/" title="' . $title . '" data-label="' . $title . '"><img src="' . $logo['url'] . '?' . time() . '" alt="' . $title . '" title="' . $title . '" /></a></h1>' . "\n";
    echo "</div>\n";
  } else {
    echo "<div id='logo_text'>\n";
    echo '<h1 id="logo"><a href="' . $url . '/">' . $title . "</a></h1>\n";
    echo '<h2 id="description">'. $tagline ."</h2>\n";
    echo "</div>\n";
  }
}
...
function _dp_delete_image(){
	if(isset($_REQUEST['page'], $_REQUEST['_wpnonce']) && !isset($_REQUEST['settings-updated']) && $_REQUEST['page'] == 'theme_options'){
		...
		$options = get_desing_plus_option();
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_main_image1')){
				$file = basename($options['index_main_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_main_image1'] = '';
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_main_image2')){
				$file = basename($options['index_main_image2']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_main_image2'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_main_image3')){
				$file = basename($options['index_main_image3']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_main_image3'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_main_image4')){
				$file = basename($options['index_main_image4']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_main_image4'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_main_image5')){
				$file = basename($options['index_main_image5']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_main_image5'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_banner_image1')){
				$file = basename($options['index_banner_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_banner_image1'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_banner_image2')){
				$file = basename($options['index_banner_image2']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_banner_image2'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_banner_image3')){
				$file = basename($options['index_banner_image3']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_banner_image3'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_index_center_banner_image')){
				$file = basename($options['index_center_banner_image']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['index_center_banner_image'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_footer_banner_image1')){
				$file = basename($options['footer_banner_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['footer_banner_image1'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_footer_banner_image2')){
				$file = basename($options['footer_banner_image2']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['footer_banner_image2'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_footer_banner_image3')){
				$file = basename($options['footer_banner_image3']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['footer_banner_image3'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_side_ad_image1')){
				$file = basename($options['side_ad_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['side_ad_image1'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_single_ad_image1')){
				$file = basename($options['single_ad_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['single_ad_image1'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_single_ad_image2')){
				$file = basename($options['single_ad_image2']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['single_ad_image2'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_mobile_ad_image1')){
				$file = basename($options['mobile_ad_image1']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['mobile_ad_image1'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
			...
			if(wp_verify_nonce($_REQUEST['_wpnonce'], 'dp_delete_mobile_ad_image2')){
				$file = basename($options['mobile_ad_image2']);
				if(file_exists(dp_logo_basedir().DIRECTORY_SEPARATOR.$file) && @unlink(dp_logo_basedir().DIRECTORY_SEPARATOR.$file)){
					$options['mobile_ad_image2'] = '';
					update_option('dp_options', $options);
					add_action('admin_notices', '_dp_delete_message_sucess');
				}else{
					add_action('admin_notices', '_dp_delete_message_error');
