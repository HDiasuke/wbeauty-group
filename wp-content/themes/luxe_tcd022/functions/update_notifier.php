...
add_dashboard_page( $theme_data['Name'] . 'Theme Updates','テーマ更新<span class="update-plugins count-1"><span class="update-count">1</span></span>', 'administrator','design-plus-updates', 'update_notifier');
	}
}  
	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="message" class="updated below-h2">
          <p><strong><?php echo $theme_data['Name']; ?>の最新版が公開されています。</strong> 現在利用しているバージョンは「<?php echo $theme_data['Version']; ?>」です。 「<?php echo $xml->latest; ?>」に更新する事ができます。</p>
         </div>
         <div id="mono_instructions">
          <h3>注意事項：最新版にアップデートする際は、必ずテーマの<strong>バックアップ</strong> をしてください。</h3>
          <p style="font-size:16px;">【 <a href="http://tcd-wp.net/dl022/luxe/luxe_tcd022.zip">最新版のテーマをダウンロードする</a> 】</p>
          <div id="mono_info">
	   <h3>更新情報</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_luxe.xml';
	
	$db_cache_field = 'opinion-contempo-notifier-cache';
	$db_cache_field_last_updated = 'opinion-contempo-notifier-last-updated';
