<?php
 ...
 // Constructor //
 function styled_post_list2_widget() {
...
?>
 <li class="clearfix">
   <div class="image"><a href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail()) { echo the_post_thumbnail('widget_size2'); } else { echo '<img src="'; bloginfo('template_url'); echo '/img/common/no_image2.jpg" alt="" title="" />'; }; ?></a></div>
   <?php if( $show_date == '1' ) { ?>
