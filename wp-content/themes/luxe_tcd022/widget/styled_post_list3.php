<?php
 ...
 // Constructor //
 function styled_post_list3_widget() {
  $widget_ops = array( 'classname' => 'styled_post_list3_widget', 'description' => __('Displays styled post list.', 'tcd-w') ); // Widget Settings
  $control_ops = array( 'id_base' => 'styled_post_list3_widget' ); // Widget Control Settings
  parent::__construct( 'styled_post_list3_widget', __('Styled post list3 (tcd ver)', 'tcd-w'), $widget_ops, $control_ops ); // Create the widget
 }
...
?>
 <li class="clearfix">
   <div class="thumb"><a class="image" href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail()) { echo the_post_thumbnail('widget_size'); } else { echo '<img src="'; bloginfo('template_url'); echo '/img/common/no_image3.jpg" alt="" title="" />'; }; ?></a></div>
   <?php if( $show_date == '1' ) { ?>
