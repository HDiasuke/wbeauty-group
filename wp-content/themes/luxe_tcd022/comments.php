...
<h3 class="headline2" id="comment_headline"><?php _e('Comment', 'tcd-w'); ?></h3>

<div id="comment_header" class="clearfix">

 <ul id="comment_header_right">
<?php if(pings_open()) ://if trackback is open ?>
   <?php if($options['show_trackback']){ ?><li id="trackback_switch"<?php if(!$options['show_comment']){ echo ' class="comment_switch_active"'; }; ?>><a href="javascript:void(0);"><?php _e('Trackback','tcd-w'); ?><?php echo (' ( ' . count($trackbacks) . ' )'); ?></a></li><?php }; ?>
   <?php if($options['show_comment']){ ?><li id="comment_switch" class="comment_switch_active"><a href="javascript:void(0);"><?php _e('Comments','tcd-w'); ?><?php echo (' ( ' . (count($comments)-count($trackbacks)) . ' )'); ?></a></li><?php }; ?>
...
<div id="comments">
 ...
 <div id="comment_area">
  ...
  <ol class="commentlist">
	...
	?>
    <li class="comment">
     <div class="comment-content"><p class="no_comment"><?php _e('No comments yet.','tcd-w'); ?></p></div>
    </li>
	<?php
		}
	?>
 ...
 <?php if($options['show_trackback']): ?>
 <div id="trackback_area"<?php if(!$options['show_comment']){echo ' style="display: block;"';}; ?>>
 <!-- start trackback -->
 <?php if (pings_open()) ://id trackback is open ?>
  ...
  <ol class="commentlist">
   ...
   <?php endforeach; ?>
   <?php else : ?>
   <li class="comment"><div class="comment-content"><p class="no_comment"><?php _e('No trackbacks yet.','tcd-w'); ?></p></div></li>
   <?php endif; ?>
  </ol>
